...
advancement_table = {
    ...
    "Water A0 - S - Ancient Key":                   AdvData(103001712, "Tidal Reef"), # frog flippers
    ...
    "Water E0 - W - Star Piece":                    AdvData(103400109, "Tidal Reef Post-Rune"), # f flippers | k cloak 
    "Water E0 - E - Star Piece":                    AdvData(103402005, "Tidal Reef Post-Rune"), # s quest & f flippers
...
circlet_table = {
    ...
    "Serpent A5 - NW - Serpent Lock Shard":         AdvData(106050207, "Serpent Stacks Lock"),
    "Serpent A5 - SW - Serpent Lock Shard":         AdvData(106050209, "Serpent Stacks Lock"),
...
mysterious_table = {
    ...
    "Aggro A0 Serpent Secret - Obsidian":           AdvData(110001807, "Aggro Crag"),
    "Nunatak A1 Serpent Secret - Obsidian":         AdvData(111012008, "Sea Nunatak"),
    "Tropic A1 Serpent Secret - Obsidian":          AdvData(113010808, "Star Tropic"),

    "Stone D0 Serpent Secret - Pyramidion":         AdvData(101301908, "Stony Cliffs Wheel Room"),
    "Stone D1 Serpent Secret - Pyramidion":         AdvData(101310206, "Stony Cliffs"),
    "Water A3 Serpent Secret - Pyramidion":         AdvData(103031008, "Tidal Reef"),
    "Fire E3 Serpent Secret - Pyramidion":          AdvData(104431712, "Raging Volcano Post-Rune"),
    ...
    "Rolling A0 Serpent Secret - Pyramidion":       AdvData(108002009, "Rolling Rocks"),
    "Rolling B1 Serpent Secret - Pyramidion":       AdvData(108110804, "Rolling Rocks Post-Rune"),
    "Sunken B0 Serpent Secret - Pyramidion":        AdvData(109101007, "Sunken Island"),
    "Aggro B1 Serpent Secret - Pyramidion":         AdvData(110111308, "Aggro Crag"),
    "Nunatak B0 Serpent Secret - Pyramidion":       AdvData(111101409, "Sea Nunatak"),
    ...
    "Serpent A5 Serpent Secret - Pyramidion":       AdvData(106050709, "Serpent Stacks Lock"),
    ...
    "Shoal A0 - Pattern Puzzle Pyramidion":         AdvData(114001305, "Shoal"), # Visit Stone A3
    "Shoal A1 - Pyramidion":                        AdvData(114012010, "Shoal Post-Circlet"), # Yes, this is possible without flippers.
    "Shoal A1 - Pattern Puzzle Pyramidion":         AdvData(114011604, "Shoal Post-Circlet"), # Visit Water E2
    "Shoal B0 - Pyramidion":                        AdvData(114101803, "Shoal North-East"), 
    "Shoal B0 - Pattern Puzzle Pyramidion":         AdvData(114100708, "Shoal North-East"), # hint in wind B0
    "Shoal B1 - Pyramidion":                        AdvData(114110312, "Shoal Post-Circlet"), # All elementals, f flippers
    "Shoal B1 - Pattern Puzzle Pyramidion":         AdvData(114110605, "Shoal Post-Circlet"), # All elementals, f flippers, hint in Fire B0

    "Lagoon B0 Serpent Secret - Pyramidion":        AdvData(117100709, "Forgotten Lagoon"), # Kite Cloak ?
...
note_table = {
    ...
    "Water A2 - Music Note":                        AdvData(103021807, "Tidal Reef"), # s rune
