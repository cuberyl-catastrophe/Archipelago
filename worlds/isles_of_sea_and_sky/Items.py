...
item_table = {
    ...
    "Big Bell Hit - Rolling":               ItemData(901,       IC.progression_skip_balancing),
    "Big Bell Hit - Sunken":                ItemData(902,       IC.progression_skip_balancing),
    "Big Bell Hit - Aggro":                 ItemData(903,       IC.progression_skip_balancing),
    "Big Bell Hit - Nunatak":               ItemData(904,       IC.progression_skip_balancing),
